...
caffe_root = 'SegNet/caffe-segnet_/' 			# Change this to the absolute directoy to SegNet Caffe
import sys
sys.path.insert(0, caffe_root + 'python')

import caffe

list_path = "SegNet/final_model/list/"			# set the path of your data list 
p = 'SegNet/final_model/0703/joint_train/result'		# set the path of results
...
line = loadtxt("SegNet/final_model/list/" args.folder ".txt", dtype='str')
